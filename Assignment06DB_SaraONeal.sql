...
-- database exists, if so drop database, then create Assignment06DB_SaraONeal database (lines 18-31)
-- 2021-02-20,SaraONeal,Use Assignment06DB_SaraONeal database (lines 31-32)
-- 2021-02-20,SaraONeal,Created Categories, Products, Employees and Inventories Tables (lines 34-64)
-- 2021-02-20,SaraONeal,Added database constraints (lines 66-129)
-- 2021-02-20,SaraONeal,Insert data into Assignment06DB_SaraONeal database (lines 131-164)
-- 2021-02-20,SaraONeal,Show all of the data in the Categories, Products, Employees and Inventories Tables (lines 166-174)
-- 2021-02-20,SaraONeal,Answered questions 1 through 10 (lines 176-480)
